...
.table td .btn-sm {
    width: 100%; /* Ensure buttons take full width within their cell */
...
@media (max-width: 768px) {
    ...
    .table td .btn-sm {
        width: auto; /* Reset to default for smaller screens */
                            ...
                            <div class="modal-content">
                                ...
                                <form action="partials/submit_review.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="user_id" value="<?php echo $_SESSION['user_id']; ?>"> <!-- Assuming you store user ID in session -->
