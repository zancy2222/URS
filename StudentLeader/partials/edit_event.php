...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $currentQuery = "SELECT letter_of_request, facility_form_request, contract_of_lease FROM student_leader_events WHERE id = ?";
    ...
    $query = "UPDATE student_leader_events SET 
                event_name = ?, 
                start_date = ?, 
                end_date = ?, 
                start_time = ?, 
