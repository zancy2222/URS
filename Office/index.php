<?php
session_start();
include 'partials/db_conn.php'; // Include your database connection
...
if (isset($_SESSION['office_id'])) {
    ...
    // Fetch office name from the office table
    $query = "SELECT office_name FROM office WHERE id = ?";
                ...
                <div class="modal-body">
                    <form id="bookingForm" enctype="multipart/form-data"> <!-- Add enctype for file uploads -->
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="officeName" name="officeName" value="<?php echo htmlspecialchars($officeName); ?>" readonly>
                        </div>
